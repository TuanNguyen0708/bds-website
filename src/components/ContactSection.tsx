      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Hãy để lại thông tin liên hệ, chúng tôi sẽ tư vấn miễn phí và 
            đưa ra giải pháp phù hợp nhất cho bạn.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div>
            <Card className="border-0 shadow-xl">
              <CardHeader>
                <CardTitle className="text-2xl text-gray-900">Gửi tin nhắn</CardTitle>
                <CardDescription>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={formData.service} onValueChange={(value) => handleChange('service', value)}>
                      ...
                      <SelectContent>
                        <SelectItem value="brokerage">Môi giới Bất động sản</SelectItem>
                        <SelectItem value="investment">Đầu tư Bất động sản</SelectItem>
                        <SelectItem value="legal">Tư vấn Pháp lý</SelectItem>
                        <SelectItem value="management">Quản lý Bất động sản</SelectItem>
          ...
          <div className="space-y-8">
            ...
            <Card className="border-0 shadow-lg bg-gray-50">
              <CardHeader>
                <CardTitle className="text-xl text-gray-900">Giờ làm việc</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-2">
