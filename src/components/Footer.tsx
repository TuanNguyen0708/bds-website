      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="mb-6">
              <h3 className="text-2xl font-bold text-blue-400">Phu Nguyen Land</h3>
            </div>
            <p className="text-gray-300 mb-6 leading-relaxed">
              Chúng tôi là công ty tư vấn bất động sản hàng đầu với hơn 10 năm kinh nghiệm. 
              Cam kết mang đến những giải pháp tối ưu nhất cho mọi nhu cầu bất động sản của bạn.
            </p>
